...
HD_PWD='E:/Desktop/posture_detection/posture_detection.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log posture_detection.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source posture_detection.tcl
