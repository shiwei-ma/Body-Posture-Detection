...
HD_PWD='E:/Desktop/posture_detection/posture_detection.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log posture_detection.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source posture_detection.tcl -notrace
